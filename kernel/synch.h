...
private:
  ...
  Listint *waiting_queue;  //!< threads waiting in P() for the value to be > 0
...
private:
  ...
  Listint *waiting_queue; //!< threads waiting to acquire the lock
...
private:
  ...
  Listint *waiting_queue;  //!< Threads asked to wait
